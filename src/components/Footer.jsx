  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <Link to="/" className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold text-white">ToyTopia</span>
            </Link>
            <p className="text-gray-400 text-base">
              Your one-stop marketplace for the best local kids' toys.
            </p>
        ...
        <div className="container bg-green-900 p-6 mt-8 text-center mx-auto">
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2024 ToyTopia, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
